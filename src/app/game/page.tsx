  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-4 pb-40 pt-8">
      <header className="mb-6">
        ...
        <h1 className="mt-1 text-2xl font-bold tracking-tight">ゲームで遊ぼう</h1>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        <article className="glass-card flex flex-col items-start gap-4 rounded-[1.4rem] p-6">
          ...
          <div>
            <h2 className="text-lg font-extrabold">タイピングゲーム</h2>
        ...
        <article className="glass-card flex flex-col items-start gap-4 rounded-[1.4rem] p-6">
          ...
          <div>
            <h2 className="text-lg font-extrabold">コード間違い探し</h2>
            <p className="mt-1 text-sm text-muted-foreground">
              コードの違いを見つけてスコアを競おう
            </p>
          </div>
